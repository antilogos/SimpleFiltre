...
function buildContext(labels, pos, svg) {
	...
	lineE1.setAttribute("y1", pos[1]+1000+2100);
	lineE1.setAttribute("x2", pos[0]+1500);
	lineE1.setAttribute("y2", pos[1]+1000+2100);
	...
	lineE2.setAttribute("y1", pos[1]+1000+3000);
	lineE2.setAttribute("x2", pos[0]+1500);
	lineE2.setAttribute("y2", pos[1]+1000+3000);
	...
	lineE3.setAttribute("y1", pos[1]+1000+3900);
	lineE3.setAttribute("x2", pos[0]+1500);
	lineE3.setAttribute("y2", pos[1]+1000+3900);
